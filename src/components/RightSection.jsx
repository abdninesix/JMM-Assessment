...
const RightSection = () => {
    return (
        <section className='w-1/2 flex flex-col items-center p-20 justify-center bg-linear-to-br from-sky-400 to-sky-950 bg- rounded-2xl'>
            {/* Design */}
                <img src='/content.png' alt='content' className='hover:rotate-2 hover:scale-105 duration-200' />
            {/* Text */}
